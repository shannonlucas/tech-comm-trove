...
- [Tech Comm link trove](#tech-comm-link-trove)
  ...
  - [References](#references)
    - [Structured text](#structured-text-1)
      - [AsciiDoc](#asciidoc-1)
      - [CSS](#css-1)
      - [DITA](#dita-1)
      - [DocBook](#docbook-1)
...
## Tools for tech comms

Each tool listed below is tagged with one or more of the following tags to
provide additional context.

- `#android` - Runs on Android devices
- `#browser-based` - Runs in a web browser
- `#education-discount` - Offers an educational discount
- `#free `- Offered at no charge (but is not open-source)
- `#freemium` - Some features are available for free while others require payment
- `#ipados` - Runs on iPad
- `#ios` - Runs on iPhone
- `#linux` - Runs on Linux
- `#macos` - Runs on macOS
...
- `#wsl` - Runs in the Windows Subsystem for Linux
...
- [asciinema](https://asciinema.org) - records terminal sessions and allows
  ...
  GIFs. `#open-source` `#wsl` `#linux` `#macos`
- [Camtasia](https://www.techsmith.com/video-editor.html) - a popular
  all-in-one screen recorder and video editor. `#paid` `#education-discount`
  `#windows` `#macos`
...
- [Snagit](https://www.techsmith.com/screen-capture.html) - a popular tool for
  ...
  `#paid` `#education-discount` `#windows` `#macos`
...
- [Oxygen XML Editor](https://www.oxygenxml.com) - a tool aimed at editing XML
  documents and content components. `#paid` `#education-discount` `#windows`
  `#linux` `#macos`
...
- [StackEdit](https://stackedit.io/) - a browser-based Markdown editor that can
  ...
  WordPress, and Zendesk. `#open-source` `#browser-based`
...
- [DITA Open Toolkit](https://www.dita-ot.org/) - a suite of command line tools
  ...
  Architecture. `#open-source` `#windows` `#wsl` `#linux` `#macos`
- [pandoc](https://pandoc.org/) - a command line tool that can convert
  documents to or from dozens of file formats. `#open-source` `#windows` `#wsl`
  `#linux` `#macos`
- [Sphinx](https://www.sphinx-doc.org/) - a tool to create documentation from
  ...
  `#open-source` `#windows` `#wsl` `#linux` `#macos`
...
- [Jekyll](https://jekyllrb.com/) - an established and robust tool for
  ...
  that powers GitHub Pages. `#open-source` `#wsl` `#linux` `#macos`
- [MkDocs](https://www.mkdocs.org/) - a fast and simple tool for building
  static sites from Markdown files. `#open-source` `#wsl` `#linux` `#macos`
